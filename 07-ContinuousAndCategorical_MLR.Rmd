...
```{r evalsscat, echo = TRUE, eval = TRUE, warning = FALSE, message=FALSE, out.width = '90%', fig.align = "center", fig.cap = "Instructor evaluation scores by age and gender. The points have been jittered."}
...
```{r parscat, echo = TRUE, eval = TRUE, warning = FALSE, out.width = '90%', fig.align = "center", fig.cap = "Instructor evaluation scores by age and gender with parallel regression lines superimposed."}
coeff  <- par.model %>% 
          coef() %>%
          as.numeric()
...
What is different between our previous scatterplot of teaching score against age (Figure \@ref(fig:evalsscat)) and the one we just created with our parallel lines superimposed (Figure \@ref(fig:parscat))?
...
Notice how the interaction model allows for different slopes for females and males (-0.018 and -0.004, respectively).  These fitted lines correspond to the fitted lines we first saw in Figure \@ref(fig:evalsscat), repeated in Figure \@ref(fig:intscat) but without the `jitter`ing:
 
```{r intscat, echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE, out.width = '90%', fig.align = "center", fig.cap = "Instructor evaluation scores by age and gender with interaction model fit added (same as Figure \\@ref(fig:evalsscat) but without jittering)."}
ggplot(eval.score, aes(x = age, y = score, color = gender)) +
  geom_point() +
  labs(x = "Age", y = "Teaching Score", color = "Gender") +
  geom_smooth(method = "lm", se = FALSE)
...
```{r intresid1, echo = TRUE, eval = TRUE, warning = FALSE, out.width = '90%', fig.align = "center", fig.cap = "Residuals vs the explanatory variable age by gender."}
...
```{r intresid2, echo = TRUE, eval = TRUE, warning = FALSE, out.width = '90%', fig.align = "center", fig.cap = "Residuals vs the fitted values."}
...
```{r intresid3, echo = TRUE, eval = TRUE, warning = FALSE, out.width = '90%', fig.align = "center", fig.cap = "Histograms of the residuals by gender."}
